  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main Section -->
			...
			<h1> Activities for <?php echo $date; ?> </h1>
			...
			<table class="table table-hover">
				...
				<?php
					...
					$query="select repeats.datein, profiles.site, profiles.fname, profiles.lname, profiles.status, repeats.sysid, repeats.in24, repeats.visitnumber, repeats.out24, repeats.hrsearned from profiles, repeats where repeats.datein = '$date' and repeats.sysid = profiles.sysid order by profiles.site, repeats.visitnumber, profiles.lname, repeats.in24";
					$result=$mysqli->query($query) or die($mysqli->error.__LINE__);
			...
			<p><strong>Total Community Service Hours Worked on <?php echo $date; ?>: <?php echo $totalhrs?></strong></p>
