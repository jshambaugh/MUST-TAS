      ...
      <!-- Main Section -->
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="DoCompleteFailedLogout.php" method="post">
						...
						<div class="control-group">
							<label class="control-label" for="sysid">Desired Logout Time (military format):</label>
							<div class="controls">
								<div class="bootstrap-timepicker">
									<input type="text" class="input-small" id="timepicker1" name="logouttime" maxlength="8"></input>
								</div>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">		
								<button type="submit" class="btn btn-primary">Complete Logout</button>
							</div>
						</div>
					</form>
				</div>
