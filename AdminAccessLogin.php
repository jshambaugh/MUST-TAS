<?php
	...
	//if already logged in, don't make them log in again
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main Section -->
				...
				<form class="form-horizontal" action="DoAdminAccessLogin.php" method="post">
					<div class="control-group">
						<label class="control-label" for="location">Enter Admin Password:</label>
						<div class="controls">
							<input type="password" name="password" autofocus></input>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">		
