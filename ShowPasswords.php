      ...
      <!-- Main Section -->
			...
			<table class="table table-hover">
				...
				<?php
					...
					/* 1.display the results of this SQL statement - select sysid, fname, lname, initialdate, orientationdate, completedate from profiles order by lname; */
					$query="select sysid, fname, lname, initialdate, orientationdate, completedate from profiles order by lname";
					...
					{
						?> <tr class="error">
										<td>There are no Users in the Database</td>
										<td></td>
										<td></td>
										<td></td>
									</tr> <?php	
