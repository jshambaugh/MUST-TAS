  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main Section -->
			...
			<h1>Deactivate User and Generate Completion Letter</h1>
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="DoCompletionLetter.php" method="post">
						<div class="control-group">
							<label class="control-label" for="county">County: (Cobb or Cherokee)</label>
							<div class="controls">
								<input type="text" name="county" value="<?php if(isset($_SESSION['county'])) echo($_SESSION['county'])?>" autofocus maxlength="10"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">Sysid:</label>
							<div class="controls">
								<input type="text" name="sysid" maxlength="7"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="date">Letter Date:</label>
							<div class="controls">
								<input type="text" data-date-format="m/d/yyyy" id="date" name="letterdate" maxlength="10"></input>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">		
								<button type="submit" class="btn btn-danger">Create Letter</button>
							</div>
						</div>
					</form>
				</div>
