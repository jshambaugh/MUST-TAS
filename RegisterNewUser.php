      ...
      <!-- Main Section -->
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="DoRegisterNewUser.php" method="post">
						<div class="control-group">
							<label class="control-label" for="fname">First Name:</label>
							<div class="controls">
								<input type="text" name="fname" autofocus maxlength="20"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="minitial">Middle Ininitial:</label>
							<div class="controls">
								<input type="text" name="minitial" maxlength="1"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="lname">Last Name:</label>
							<div class="controls">
								<input type="text" name="lname" maxlength="20"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="rdate">Initial Registration Date:</label>
							<div class="controls">
								<input type="text" data-date-format="m/d/yyyy" id="rdate" name="rdate" maxlength="12"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="odate">Orientation Date:</label>
							<div class="controls">
								<input type="text" data-date-format="m/d/yyyy" id="odate" name="odate" maxlength="12"></input>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<div class="bootstrap-timepicker">
									<input type="text" class="input-small" id="timepicker1" name="otime" maxlength="8"></input>
								</div>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="sysid" maxlength="7"></input>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label" for="sysid">SSAN:</label>
							<div class="controls">
								<input type="text" name="social" maxlength="9"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">Age:</label>
							<div class="controls">
								<input type="text" name="age" maxlength="3"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">Street Address:</label>
							<div class="controls">
								<input type="text" name="street" maxlength="30"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">City:</label>
							<div class="controls">
								<input type="text" name="city" maxlength="10"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">State:</label>
							<div class="controls">
								<input type="text" name="state" maxlength="2"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">Zip Code:</label>
							<div class="controls">
								<input type="text" name="zip" maxlength="5"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="sysid">County:</label>
							<div class="controls">
								<input type="text" name="county" maxlength="10"></input>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">		
