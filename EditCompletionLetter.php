  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Main Section -->
			...
			<h1>View or edit Completion Letter Form</h1>
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="EditLetter.php" method="post">
						...
						<div class="control-group">
							<div class="controls">		
								<button type="submit" class="btn btn-danger">View/Edit Letter</button>
							</div>
						</div>
					</form>
				</div>
