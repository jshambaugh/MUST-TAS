      ...
      <!-- Main Section -->
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="DoEditHoursEarned.php" method="post">
						<div class="control-group">
							<label class="control-label" for="sysid">System ID:</label>
							<div class="controls">
								<input type="text" name="sysid" autofocus maxlength="7"></input>
							</div>
						</div>
	<!--				<div class="control-group"> 
							<label class="control-label" for="activityno">Activity Number (leave blank for most recent activity):</label>
							<div class="controls">
								<input type="text" name="activityno"></input>
							</div>
						</div> -->
						<div class="control-group">
							<label class="control-label" for="addedtime">Time to be Added (in hours, where 1.25 is one hour and 15 minutes):</label>
							<div class="controls">
								<input type="text" name="addedtime"></input>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">		
