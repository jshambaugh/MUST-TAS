      ...
      <!-- Main Section -->
			...
			<div class="row">
				<div class="offset3">
					<br>
					<br>
					<form class="form-horizontal" action="DoChangeAdminPassword.php" method="post">
						<div class="control-group">
							<label class="control-label" for="oldpw">Enter Old Password:</label>
							<div class="controls">
								<input type="password" name="oldpw" autofocus></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="oldpw">Enter New Password:</label>
							<div class="controls">
								<input type="password" name="newpw"></input>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="oldpw">Confirm New Password:</label>
							<div class="controls">
								<input type="password" name="confirmpw"></input>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">		
